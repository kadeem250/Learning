...
def low():
    ...
    strong = letters + digits + special_char
    password = ""
...
def generate():
    ...
    passwrd= low()
    entry.insert(10, passwrd)
"""
# Function for generation of password
def generate():
    password1 = low()
    entry.insert(2, password1)
...
root.title("Kadeem's Password Generator")
...
generate_button = Button(root, text="Save", command=savefile)
generate_button.grid(row=0, column=4)

#generate_button = Button(root, text="Complex", command=genpass())
